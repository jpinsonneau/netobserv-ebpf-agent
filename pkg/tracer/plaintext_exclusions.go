...
// isGoTLSExcluded is kept as an alias for existing call sites and tests.
func isGoTLSExcluded(resolvedPath, comm string) bool {
	return isPlaintextCaptureExcluded(resolvedPath, comm)
}
